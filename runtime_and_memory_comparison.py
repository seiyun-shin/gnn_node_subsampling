...
from utils import lev_approx2, normal_equations, rank_one_minVar_sampling, rank_one_uniform_sampling, uniform_sampling_rows, lev_exact, lev_score_sampling, normalize_adj, generate_dataset, generate_dataset_syn

error_msg = "Usage: python -m memory_profiler runtime_and_memory_comparison.py (dataset: house|ogbl-ddi|ogbn-arxiv|generated-data)"
if sys.argv != 1:
    print(error_msg)
    sys.exit()
input = sys.argv[1]
...
def method3():
    ...
    sampled_rows1, exact_lev_data_mat, scaling_vec1 = lev_score_sampling(A_G, sketch_size, exact_lev_score)
...
def method4():
    ...
    sampled_rows2, approx_lev_data_mat, scaling_vec2 = lev_score_sampling(A_G, sketch_size, approx_lev_score)
...
def method5():
    ...
    sampled_rows3, approx_lev_data_mat_minVar, scaling_vec3 = lev_score_sampling(A_G, sketch_size, approx_lev_score_minVar)
